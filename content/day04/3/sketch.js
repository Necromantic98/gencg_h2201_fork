...
//   }
  ...
  drawStartOrbitalLines(angle1, radius1, adder1, 'red')
  drawOrbitalLines(angle2, radius2, adder2, 'white')
  drawOrbitalLines(angle3, radius3, adder3, 'lightgreen')
  // drawOrbitalLines(angle4, radius4, adder4, 'yellow')
  // drawOrbitalLines(angle5, radius5, adder5, 'magenta')
